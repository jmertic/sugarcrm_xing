...
class ext_rest_xing extends ext_rest 
{
    ...
    public function test() {
        ...
        $api = ExternalAPIFactory::loadAPI('Xing', true);

        if ($api) {
            $properties = $this->getProperties();
            $config = array(
                'callbackUrl' => 'http://www.sugarcrm.com',
                'siteUrl' => 'https://api.xing.com/v1',
     ...
     * getItem
     *
     * As the xing connector does not have a true API call, we simply
